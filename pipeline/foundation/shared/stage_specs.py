...
class TranslateStageSpec:
    ...
    def load(cls, path: Path) -> "TranslateStageSpec":
        ...
        params = TranslateStageParams(
            ...
            enable_table_translation=bool(params_payload.get("enable_table_translation", False)),
            ...
            glossary_hard=bool(params_payload.get("glossary_hard", False)),
...
class ProviderStageSpec:
    ...
    def load(cls, path: Path) -> "ProviderStageSpec":
        ...
        translation = ProviderStageTranslationParams(
            ...
            enable_table_translation=bool(translation_payload.get("enable_table_translation", False)),
            ...
            glossary_hard=bool(translation_payload.get("glossary_hard", False)),
